...
#include <list>
#include <utility>
#define LOGI(...)  if(DEBUG) __android_log_print(ANDROID_LOG_INFO,KALIN_LOG_TAG,__VA_ARGS__)
#define LOGE(...)  if(DEBUG) __android_log_print(ANDROID_LOG_ERROR,KALIN_LOG_TAG,__VA_ARGS__)
using namespace std;
...
#       define KL_Map      map
#       define KL_List      list
#       define KL_HashMap std::unordered_map
#       define KL_HashMultiMap ::__gnu_cxx::hash_multimap
#       define KL_HashSet ::__gnu_cxx::hash_set
#       define KL_HashMultiSet ::__gnu_cxx::hash_multiset
