...
/// Construct with parent texture.
    explicit RenderSurface(Texture
                           *parentTexture);
...
/// Return linked color rendertarget.
    RenderSurface *GetLinkedRenderTarget() const { return linkedRenderTarget_.lock().get(); }

/// Return linked depth-stencil surface.
    RenderSurface *GetLinkedDepthStencil() const { return linkedDepthStencil_.lock().get(); }
...
/// Viewports.
    vector<shared_ptr<Viewport>> viewports_;
/// Linked color buffer.
    weak_ptr <RenderSurface> linkedRenderTarget_;
/// Linked depth buffer.
    weak_ptr <RenderSurface> linkedDepthStencil_;
